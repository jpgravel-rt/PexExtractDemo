...
near you to reduce the burden on our poor production systems. Especially if you consult the same
time range for the same tags.

Always remember that PI is an historian, not geared toward extensive data analysis.
